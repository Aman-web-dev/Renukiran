...
function form() {
  return (
    <div className='absolute  z-20 m-auto'>
      ...
      <div>
         ...
         <div className="mt-5 bg-white rounded-lg shadow">
            ...
            <div className="px-5 pb-5">
               ...
               <div className="flex items-center pt-3"><input type="checkbox" className="w-4 h-4 text-black bg-gray-300 border-none rounded-md focus:ring-transparent"/><label for="safeAdress" className="block ml-2 text-sm text-gray-900">Save as default address</label></div>
            </div>
            <div className="flex">
               <div className="flex-1 py-5 pl-5 overflow-hidden">
