          ...
          >
            <ul className="font-medium flex flex-col p-4 md:p-0 md:items-center mt-4 border md:flex-row   md:mt-0 md:border-0 gap-4">
              ...
              <li className="hidden md:block ml-4">
                <Link
                  href="/donate"
                  className="bg-[#205893] py-2 pl-3 pr-4 text-white rounded md:hover:border-blue-800 md:px-2 md:hover:text-[#205893] uppercase md:hover:bg-transparent md:hover:border"
                >
                  Support us
                </Link>
              </li>
