...
function vision() {
  return (
    <div className=' p-4 text-center text-xl font-serif  align-center justify-center '
     style={{
        backgroundImage:
          ' url("")',
  ...
  <div className='flex w-[80vw] m-auto flex-col font-serif text-6xl font-bold align-center justify-center my-4'>
        ...
        <p className="mb-6 w-[90%] m-auto text-center text-xl backdrop-filter backdrop-blur-sm bg-opacity-50 font-bold  text-white lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400 ">Our NGO passionately works for child education, women's empowerment, and community cleanliness—dedicated to holistic societal welfare</p>
