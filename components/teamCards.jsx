...
function teamCards({name,designation,pic}) {
  return (
    <section className="bg-white dark:bg-gray-900 w-[80vw] xl:w-[20vw] md:w-[40vw] sm:[w-40vw] sm:w-[70vw]  shadow-md my-8 m-auto">
  <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
     
      <div className="">
          
          <div className="text-center text-gray-500 dark:text-gray-400">
            <div className='mx-auto mb-4 w-36 h-36 border  rounded-full ' style={{
        ...
        backgroundRepeat: "no-repeat",
            ...
            backgroundPosition:"center",
              ...
              {/* <img className="mx-auto mb-4 w-36 h-36 rounded-full " src={pic} alt="Neil Avatar" /> */}
            </div>  
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">{name}</a>
              </h3>
              <p className='text-center text-wrap'>{designation}</p>
