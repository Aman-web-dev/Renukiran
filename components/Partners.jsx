      ...
      <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
        ...
        <div className="hidden lg:mt-8 lg:flex lg:gap-4">
          ...
          onClick={handlePrevClick}
            ...
            className="rounded-full border border-blue-700 p-3 text-blue-600 transition hover:bg-blue-700 hover:text-white"
          >
            <svg
...
{/* not mapping here */}
                ...
                >
                  <div>
                    ...
                    <div className="mt-4">
                      ...
                      <Image priority={true} src={partnersData.icon} alt={partnersData.author} width={100} height={100} className='mb-8'/>
                      </div>
    ...
    <div className="mt-8 justify-center gap-4 hidden">
      <button
        ...
        className="rounded-full border border-blue-700 p-4 text-blue-600 transition hover:bg-blue-700 hover:text-white"
      >
        <svg
