...
//   const sliderRef = useRef(null); // Create a ref for the KeenSlider instance

//   useEffect(() => {
//     // Initialize KeenSlider when the component mounts
...
//     return () => {
//       // Clean up KeenSlider when the component unmounts
