        ...
        <div className="relative max-w-7xl mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Renukiran Welfare Foundation values its employees, nourishing
              their internal strength and treating them with respect by actively
              listening to their ideas and offering support in every way.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-12 text-white">
            ...
            <p className="text-xl mb-8 opacity-90">
              Join our passionate team of changemakers and help us transform
              lives across India. Together, we can create lasting impact in
