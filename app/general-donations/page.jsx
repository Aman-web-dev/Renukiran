      ...
      <div className="mb-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-700 mb-4 max-w-2xl mx-auto">
            Every donation helps us provide essential services to communities in
            need. Our programs focus on sustainable development, education, and
            healthcare initiatives that create lasting change for vulnerable
        ...
        <div className="bg-blue-50 p-6 rounded-lg mb-8">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-700">
              {" "}
              3,6,12,15,other We commit to using 92% of all donations directly
        ...
        <div className="text-center py-8 bg-gray-50 rounded-lg">
          ...
          {/* <a
            ...
            className="bg-blue-600 ,b-4 hover:bg-blue-700 text-white font-medium py-4 px-8 rounded-md text-lg transition duration-200"
          >
            Donate Now
          </a> */}
          <RazorpayButton />
