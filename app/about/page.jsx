...
<h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white"><span className='text-green-600'>Renukiran</span> <span>Aasha Ki kiran</span></h1>
