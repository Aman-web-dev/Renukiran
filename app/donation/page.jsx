    ...
    return (
        ...
        <div>
            <div className='flex flex-col text-center align-center justify-center my-4'>
                ...
                <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Donation Form</h1>
                <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Complete the form to donate items. Your contributions enhance community welfare. Choose what you can give, and your donations will directly benefit those in need. Make a positive impact today</p>
            </div>
