...
<h3 className="text-3xl font-bold   text-blue-900 dark:text-black">Avinash Kumar<span> (Founder & Director)</span></h3>
      ...
      <div className='flex justify-center flex-col'>
            <div className='my-4'>
                  <Image width={700} height={600} src='https://firebasestorage.googleapis.com/v0/b/speakup-aa4f8.appspot.com/o/thumbnails%2Favinash_sir_pfp.JPG?alt=media&token=9b443e2b-0b7b-4e87-a2f6-21272ccc8278&_gl=1*1amastk*_ga*Njc4NjI1OTEyLjE2OTI4NjkyOTU.*_ga_CW55HF8NVT*MTY5NzAxODEyNi4yNS4xLjE2OTcwMTk1MTEuMjYuMC4w' loading='lazy' className='rounded-xl w-full' alt='Avinash Kumar'/>
            </div>
