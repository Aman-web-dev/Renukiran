...
<Image src='https://renukiran.b-cdn.net/backgroundImages/avinash_sir_pfp.JPG' className='rounded-xl  h-[100%] w-[30vh] sm:m-auto m-auto' height={1000} width={1400}></Image>
