      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">
            Contact Renukiran Welfare Foundation
          </h2>
          <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
            Got a Reason To Contact Renukiran Welfare Foundation please fill
            this Form and Let us Know Your Idea, Suggestion, FeedBack etc.
          </p>
          <form action="#" className="space-y-8" onSubmit={handleFormSubmit}>
            ...
            <div className="">
              ...
              <select
                className="border border-grey-300 bg-gray-50 rounded-lg"
                name="Subject"
            ...
            <button
              type="submit"
              className="focus:outline-none text-white bg-[#205893]   focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
              disblaed={buttonState}
            >
              {buttonText}
            </button>
          </form>
          ...
          <div className="h-[250px] max-h-[300px] shadow-md p-8 w-full max-w-[300px] relative border border-gray-200 flex items-center justify-center">
            ...
            <div className="w-full flex flex-col items-center justify-between h-full">
              ...
              <div className="flex-1 w-full flex justify-center items-center flex-col">
                <h3 className="truncate header-text-400 text-black text-lg">
                  Phone
                </h3>
                <span id="phone" className="truncate sub-text-400">
                  +91 9625881835
                </span>
              </div>
            </div>
          ...
          <div className="h-[250px] max-h-[300px] shadow-md p-8 w-full max-w-[300px] relative border border-gray-200 flex items-center justify-center">
            ...
            <div className="w-full flex flex-col items-center justify-between h-full">
              ...
              <div className="flex-1 w-full flex justify-center items-center flex-col">
                ...
                <span id="email" className="truncate sub-text-400">
                  info@renukiran.org
                </span>
              </div>
            </div>
            ...
            <div className="shadow-md p-8 w-full max-w-[300px] relative border border-gray-200 flex items-center justify-center h-[250px] max-h-[300px]">
              ...
              <div className="w-full flex flex-col items-center justify-between h-full">
                ...
                <div className="flex-1 w-full flex justify-center items-center flex-col">
                  ...
                  <span
                    id="address"
                    className="text-center sub-text-400 w-full"
                  >
