...
export const impactPartners = [
  {
    ...
    client: {
      name: "Amazon",
      shortName: "Amazon",
      logo: "/assets/icons/company-logo/amazon.svg",
      website: "https://www.aboutamazon.in/impact/community",
      description: [
        "Amazon is a global technology and e-commerce company with a broad commitment to supporting the communities in which its teams live and work. Community-led volunteering gives employees an opportunity to contribute their time, energy and skills to locally relevant causes.",
        "Renukiran Welfare Foundation collaborated with Amazon on a focused food-security engagement in Delhi. The partnership brought corporate and community volunteers together to prepare and distribute essential ration support with dignity, care and strong on-ground coordination.",
      ],
    },
    activity: {
      title: "Community Nutrition & Ration Support Drive",
      type: "Employee volunteering",
      theme: "Food security",
      date: "28 August – 2 September 2023",
      dateISO: "2023-08-28",
      location: "New Ashok Nagar (Phase 1) & Okhla Vihar, Delhi",
      locations: ["New Ashok Nagar (Phase 1)", "Okhla Vihar"],
      summary:
        "A collaborative employee engagement designed to provide essential food supplies to families navigating economic hardship, while strengthening community participation and shared responsibility.",
      objective:
        "The engagement set out to address immediate nutritional needs, create a thoughtful volunteering experience for employees, and make distribution safe, organised and respectful for every participating family.",
      details: [
        {
          title: "Preparing support with purpose",
          description:
            "Amazon and Renukiran volunteers worked together to assemble ration kits containing everyday food essentials and basic hygiene products.",
          points: [
            "Rice, wheat flour, lentils, cooking oil, spices and salt were included.",
            "100 ration kits—approximately 500 kilograms of support—were prepared.",
            "Every kit was organised for a simple and dignified handover.",
          ],
        },
        {
          title: "Community-led distribution",
          description:
            "Distribution was coordinated at accessible community locations across New Ashok Nagar and Okhla Vihar, with local and employee volunteers supporting an orderly experience.",
          points: [
            "Volunteer teams supported registration, movement and kit handover.",
            "Safety and hygiene practices were integrated throughout the activity.",
            "Community representatives helped identify and guide participating families.",
          ],
        },
        {
          title: "Awareness through conversation",
          description:
            "The engagement went beyond the handover of supplies. Volunteers created space for practical conversations around balanced nutrition, hygiene and family well-being.",
          points: [
            "Participants shared needs, observations and feedback with the field team.",
            "Simple nutrition and hygiene messages accompanied the distribution.",
            "The format encouraged empathy and direct employee-community connection.",
          ],
        },
      ],
    },
    coverImage: {
      src: amazonActivityImage,
      alt: "Amazon and Renukiran community ration support activity in Delhi",
      position: "center",
    },
    gallery: [
      {
        src: amazonActivityImage,
        alt: "Ration kits being distributed during the Amazon community engagement",
        caption:
          "Corporate and community volunteers came together for a carefully coordinated ration-support activity.",
      },
    ],
    map: {
      latitude: 28.5486,
      longitude: 77.2782,
      zoom: 12,
      label: "New Ashok Nagar & Okhla Vihar, Delhi",
      embedUrl:
        "https://maps.google.com/maps?q=28.5486,77.2782&t=k&z=12&output=embed",
      earthUrl:
        "https://earth.google.com/web/search/New+Ashok+Nagar,+Delhi,+India",
      mapsUrl:
        "https://www.google.com/maps/search/?api=1&query=28.5486%2C77.2782",
    },
    impact: {
      heading: "Immediate relief, powered by collective action",
      paragraphs: [
        "The drive provided essential food support to 80 families—approximately 200 to 250 people—helping households access balanced staples during a period of financial pressure. By organising distribution across two communities, the partnership directed resources where they could make an immediate and practical difference.",
        "The impact also extended to the people who participated. Amazon employees, Renukiran volunteers and community members worked side by side, turning a distribution activity into an experience of empathy, teamwork and shared civic responsibility. The engagement demonstrated how corporate participation can strengthen grassroots delivery when it is built around local knowledge.",
      ],
      stats: [
        { value: "80", label: "families supported" },
        { value: "200–250", label: "people reached" },
        { value: "100", label: "ration kits prepared" },
        { value: "500 kg", label: "essential supplies" },
      ],
      sdgs: [
    ...
    conclusion:
      "This engagement showed what becomes possible when corporate intent is matched with trusted grassroots execution. Together, Amazon and Renukiran translated employee participation into timely nutrition support, stronger community connections and a replicable model for purpose-led volunteering.",
    thankingNote:
      "Our heartfelt thanks to Amazon and every employee volunteer who gave their time and energy to this initiative. We are equally grateful to our community representatives, field coordinators and Renukiran volunteers, whose care made every interaction respectful and every handover meaningful. This impact belongs to all of you.",
    specialMentions: [
      {
        name: "Amazon employee volunteers",
        role: "Corporate volunteer team",
        note: "For preparing kits and supporting a thoughtful, people-first distribution.",
        url: "https://www.aboutamazon.in/impact/community",
        linkLabel: "Amazon in the community",
      },
      {
        name: "Community representatives",
        role: "Local coordination",
        note: "For helping the team reach families with sensitivity and local insight.",
      },
      {
        name: "Renukiran field volunteers",
        role: "Programme delivery",
        note: "For planning, mobilisation, documentation and on-ground execution.",
      },
    ],
  },
  {
